...
public class Updates_Spigot implements HttpHandler {
    public void handle(HttpExchange t) throws IOException {
        ...
        if(params.get("token") !=null){
            ...
            if(HttpRouter.isTokenValid(token)){
                ...
                UpdatesList updatesList = HttpRouter.getDataManager().getDataset_spigot().getUpdates();
                updatesList.stream().map(Update::getState).forEach(updates::add);
                
                obj.put("data", updates);
